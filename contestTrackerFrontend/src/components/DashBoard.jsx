...
const RATING_SOURCE = {
  ...
  gfg: {
    ...
    history: (d) =>
      d.gfgRatingHistory ?? d.gfgHistory,
  },

  hackerrank: {
    rating: (d) => d.hackerrankRating,
    history: (d) =>
      d.hackerrankRatingHistory ?? d.hackerrankHistory,
  },
};
...
const PROFILE_URL_BUILDERS = {
  ...
  atcoder: (u) =>
    `https://atcoder.jp/users/${encodeURIComponent(
      u
    )}`,

  hackerrank: (u) =>
    `https://www.hackerrank.com/profile/${encodeURIComponent(
      u
    )}`,

  naukri: (u) =>
    `https://www.naukri.com/code360/profile/${encodeURIComponent(
      u
    )}`,
};
...
export default function Dashboard() {
    ...
    async (jobId) => {
      for (
        ...
        if (!res.ok) {
          throw new Error(
            json?.message ||
            "Failed to check refresh status"
          );
        }
      ...
      throw new Error(
        "Dashboard refresh is taking too long"
      );
    };
  ...
  const totalSolvedAcrossPlatforms =
    data.totalSolved ?? 0;
    ...
    <div style={s.wrap}>
      ...
      >
        ...
        >
          ...
          >
            <SectionLabel dot="#2FD9A8">
              Platforms
            </SectionLabel>

            {connectedPlatformRows.length ===
              0 ? (
              <div
                style={
                  s.emptyPlatformsNote
                }
              >
                No platforms
                connected yet.
...
function LegendRow({
  ...
  return (
    <div className="ct-legend-row">
      ...
      {notConnected ? (
        <span className="ct-legend-value is-empty">
          Not connected
        </span>
      ) : (
                  ...
                  (c) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="ct-contest-title">
                          {
                            c.title
                          }
                        </div>
...
const GLOBAL_CSS = `
  ...
  .ct-heat-cell.is-first {
    border-color: #4B5563;
  }

  .ct-heat-cell.is-active {
    background: #2FD9A8;
  }
...
const s = {
  ...
  heroGlow: {
    ...
    background:
      "radial-gradient(circle, #2FD9A833 0%, transparent 70%)",
  ...
  hexBadge: {
    ...
    background:
      "linear-gradient(160deg, #F7B84B, #FFA116)",
